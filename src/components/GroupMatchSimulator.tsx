...
export const GroupMatchSimulator = ({
  ...
  const getPhaseMessage = () => {
    switch (phase) {
      ...
      case "checking":
        return result?.requiredSecondRoll ? `¡${strongerTeam.name} no ganó! Segundo lanzamiento disponible` : "Evaluando resultado...";
      case "second-roll":
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <ScrollArea className="flex-1 min-h-0 pr-4">
          <div className="space-y-6 pb-4">
            ...
            {/* Level Info */}
            <div className={cn("text-center text-sm", advantageInfo.color)}>{advantageInfo.text}</div>
              ...
              >
                ...
                <div className="flex items-center justify-center gap-8">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    {showFirstRoll && <span className="font-display text-2xl text-primary">{result.firstRoll.home - 1} goles</span>}
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    {showFirstRoll && <span className="font-display text-2xl text-primary">{result.firstRoll.away - 1} goles</span>}
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-8">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      />
                      <span className="text-sm font-medium">{homeTeam.name}</span>
                      {showSecondRoll && <span className="font-display text-2xl text-gold-dark">{result.secondRoll!.home - 1} goles</span>}
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      />
                      <span className="text-sm font-medium">{awayTeam.name}</span>
                      {showSecondRoll && <span className="font-display text-2xl text-gold-dark">{result.secondRoll!.away - 1} goles</span>}
                    </div>
                  </div>
                </div>
              )}
